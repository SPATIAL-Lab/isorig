...
\arguments{
  ...
  \item{known}{
data.frame. Known origin tissue isotope values. Three columns: 1. longitude, 2. latitude, 3. isotope values. This isotope should be the same as the environmental isoscape.
}
  \item{valiStation}{
